	...
	<div class="col-lg-12">
		...
		<div class="row">
			...
			<div class="col-md-12">
                ...
                <span class="float:middle"><a class="btn btn-info btn-block btn-sm col-sm-2 float-right" href="javascript:void(0" id="Requests">
					<i class="fa fa-plus"></i> Requests
				</a></span>
...
<script>
	...
	$('#Requests').click(function(){
		uni_modal("Requests","manage_requests.php","mid-large")
